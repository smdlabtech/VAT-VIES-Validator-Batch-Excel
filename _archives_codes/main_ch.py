...
if uploaded is not None:
    ...
    st.subheader("2. Lancer la vérification VAT VIES")
    if st.button("🚀 Lancer"):
        def _status(msg: str):
        ...
        # ----- Journal -----
        with st.expander("🪵 Journal d’exécution (logs)", expanded=False):
...
st.markdown("---")
st.caption("⚠️ Utilise delay/retries/chunks pour éviter les erreurs 429. Le mode démo permet de tester l’UI sans réseau.")
